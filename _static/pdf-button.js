...
// named "<part>--<name>.pdf" (e.g. "03-electrodynamics--induction.pdf").
// Everywhere else (volume landing pages, front matter) it serves the whole
// book — which the Preface and the site footer also link.
(function () {
  var RELEASE =
    "https://github.com/ramador09/elementary-computational-physics-public/releases/latest/download/";
  var FULL = RELEASE + "elementary-computational-physics.pdf";
